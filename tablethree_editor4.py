...
def table_three(connections_after,filename,mode):
    ...
    for index,con in enumerate(con_array):
                    ...
                    if temp_count != 0:
                        ...
                        #29
                        Same_srv_rate.append(float(temp_same_srv_rate)/temp_count)
                        #30
                        Diff_srv_rate.append(1- (float(temp_same_srv_rate)/temp_count))			
                    else:
    ...
    for index,i in enumerate(connections_after):
                temp = str(Count[index]) + "," + str(Srv_count[index]) + "," + str(Serror_rate[index]) + "," + str(Srv_serror_rate[index]) + "," + str(Rerror_rate[index]) + "," + str(Srv_rerror_rate[index]) + "," + str(Same_srv_rate[index]) + "," + str(Diff_srv_rate[index])+ "," + str(Srv_diff_host_rate[index]) + "," + str(Dst_host_count[index]) + "," +str(Dst_host_srv_count[index]) + "," + str(Dst_host_same_srv_rate[index]) + "," + str(Dst_host_diff_srv_rate[index]) + "," + str(Dst_host_same_src_port_rate[index]) + "," + str(Dst_host_srv_diff_host_rate[index]) + "," + str(Dst_host_serror_rate[index]) + "," + str(Dst_host_srv_serror_rate[index]) + "," +str(Dst_host_rerror_rate[index]) + "," + str(Dst_host_srv_rerror_rate[index]) 
